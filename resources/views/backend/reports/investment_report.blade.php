	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<span class="panel-title">{{ _lang('Investment Report') }}</span>
			</div>
			...
			<div class="card-body">
				...
				<div class="report-params">
					<form class="validate" method="post" action="{{ route('reports.loan_report') }}">
						<div class="row">
							...
							<div class="col-xl-2 col-lg-4">
								<div class="form-group">
								<label class="control-label">{{ _lang('Investment Type') }}</label>
				...
				<table class="table table-bordered report-table">
					<thead>
						<th>{{ _lang('Investment ID') }}</th>
						<th>{{ _lang('Customer No') }}</th>
						<th>{{ _lang('Created') }}</th>
						<th>{{ _lang('Investment Product') }}</th>
						<th>{{ _lang('Investor') }}</th>
