			...
			<div class="sidebar-menu">
				...
				<div class="sidebar-header text-center">
					<a href="{{ route('dashboard.index') }}">
						<h4 class="text-white ml-1 d-inline-block">{{ get_option('site_title','Creditly') }}</h4>
					</a>	
				</div>
							...
							<div class="breadcrumbs-area clearfix">
								...
								<div class="dropdown float-right">
									<a class="dropdown-toggle btn btn-dark btn-xs" type="button" id="selectLanguage" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										{{ session('branch') =='' ? _lang('All Branches') : session('branch') }}
									</a>
									<div class="dropdown-menu" aria-labelledby="selectLanguage">
									<a class="dropdown-item" href="{{ route('switch_branch') }}">{{ _lang('All Branches') }}</a>
